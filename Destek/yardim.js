...
`
  ...
  let ekonomi = new Discord.MessageEmbed()
    ...
    .setColor("#ffff00").setDescription(`
...
`); //== BEERCODE (https://discord.gg/ew3dpTu4Z5) BEERCODE ==\\
  ...
  //== BEERCODE (discord.gg/ew3dpTu4Z5) BEERCODE ==\\
  if (args[0] === "economy" || args[0] === "economy")
    return message.channel.send(ekonomi);
  if (
    args[0] === "games" ||
    args[0] === "game" ||
    args[0] === "games" ||
    ...
    return message.channel.send(oyunlar);
};

//== BEERCODE (discord.gg/ew3dpTu4Z5) BEERCODE ==\\
exports.conf = {
  enabled: true,
  aliases: ["gamejs", "ho", "gambe", "gambeing"]
};
